...
// 创建敌方集合
	...
	public void launchFrame()
	{
		...
		new paintThread().start();
		  ...
		  //往敌方容器中添加敌方
		 //创建一个敌方1号出来
		   EnemyPlane enemy1=new EnemyPlane(110, 60, 1,this,false);
			//创建2号
		   EnemyPlane enemy2=new EnemyPlane(320, 60, 1,this,false); 
		   EnemyPlane enemy3=new EnemyPlane(220, 200, 1,this,false); 
		enemys.add(enemy1);
		enemys.add(enemy2);
		enemys.add(enemy3);
	}
